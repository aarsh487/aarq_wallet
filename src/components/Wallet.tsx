    ...
    <div className="">
      {wallets.length === 0 && (
        <div
         className="mt-40">
          {pathTypes.length === 0 && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { duration: 2 } }} className="flex justify-center items-center">
              <div className="">
                ...
                <div className="flex gap-4 justify-center items-center">
                  <motion.button whileHover={{ scale: 1.1 }} transition={{ duration: 0.2 }} whileTap={{ scale: 0.95 }}
          ...
          {pathTypes.length !== 0 && (
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { duration: 1 } }} className="flex justify-center items-center">
      ...
      {wallets.length > 0 && (
        <motion.div  initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { duration: 0.5 } }} className="mt-10">
          <div className="flex gap-4 justify-center items-center">
            <motion.button whileHover={{ scale: 1.1 }} transition={{ duration: 0.2 }} whileTap={{ scale: 0.95 }}
              className="px-6 py-3 rounded-lg cursor-pointer bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white/20 transition"
          ...
          <div className="lg:px-40 md:px-20 px-4 mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
              {wallets.map((wallet, index) => (
                <motion.div variants={walletVariants} initial="hidden" animate="visible"
                  key={index}
      ...
      <div>
        {showMnemonic && (
          <div  className="">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { duration: 0.5 } }} className="fixed inset-0 flex justify-center items-center bg-black/20 backdrop-blur-xs  bg-opacity-50">
